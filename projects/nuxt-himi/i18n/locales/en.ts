const en = {
    ...
    services: {
        ...
        incorporation_steps: 'Choosing a Company Name;Determining the Company Type;Deciding on a Financial Year End;Appointing Directors, Company Secretary and Other Key Personnel;Share Capital;Shares and Shareholders;Constitution;Application ;Other Obligations',
        ...
        secretarial_steps: 'Preparation & Holding of AGM;Preparation & Filing of Annual Return;Share capital reduction, shares allotment and transfer;Declare & Distribute dividends;Appoint & Register director/corporate secretary/auditor;Filing Register of Registrable Controllers (RORC) and Date Protection Officer (DPO);CorpPass Registration;Other changes',
        ...
        taxation_steps: 'Bookkeeping;Bank Reconciliation;Accounting System Set-up;Account Transaction Recording;Monthly, Quarterly, Yearly Review & Reporting;Management Reports;Ratio Analysis;Income Tax Computation and Filing',
        ...
        advisory_steps: 'Onboarding service on new hires to your company;Workflows Optimization;Payroll Advisory;Costing;Team Management;System Customization ;Bespoke Business Solution',
        ...
        agency_steps: 'Apply Work Pass;Preparation of Submission to MOM;Recruitment Work;Migration Service',
        ...
        incubator_steps: 'Structural Acceleration;Business Fundamental Resourcing ;Shared Workspace Support;Evaluating Programs',
    ...
    contact: {
        ...
        business_hours_content: '9.00AM to 6.30PM. Monday to Friday, excluding Public Holiday'
    },
